...
export default function WatchPage() {
  ...
  const handleEpisodeClick = async (ep) => {
    ...
    router.push(`/watch/${slug}/${newEpisodeSlug}?title=${title}&anime_type=${anime_type}`, {
      scroll: false,
    });
  ...
  return (
    <div className="watch-page-container min-h-screen bg-[#121212] text-white mt-20">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="grid grid-cols-2 gap-y-2 gap-x-6 text-sm text-gray-300">
                ...
                <div>
                  ...
                  <span>{animeDetail.film_stats.type || "?"}</span>
                </div>
                ...
                <div>
                  ...
                  <span>{animeDetail.film_stats.subtitles}</span>
                </div>
